export const faqPublic = {
  ...
  Food: [
    {
      ...
      answer:
        "Ethyl alcohol for disinfection only. As much as we would like to, the venue does NOT allow it.",
    },
    {
      question: "Will you be accommodating any diet restrictions?",
      answer: "This is a feast, diet sometime else.",
    },
    {
  ...
  Venue: [
    ...
    },
    {
      ...
      answer:
        "Yes. Since we are in a pandemic we would like to limit the movements of each guest to one place, so they don't have to commute or travel to a different location in one day.",
    },
    {
  ...
  Others: [
    ...
    },
    {
      ...
      answer: "Please go to Jeanaica.com for more information.",
    },
  ],
};
